...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        self.person_ids = []
        for person_id in os.listdir(self.instance_data_root):
            person_dir = self.instance_data_root / person_id
            self.instance_images_path.extend(list(person_dir.iterdir()))
            self.person_ids.extend([person_id] * len(list(person_dir.iterdir())))
    ...
    def unique_ids(self):
        ...
        """
        return sorted(set(self.person_ids))
